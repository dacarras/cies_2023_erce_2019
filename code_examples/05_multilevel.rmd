...
style_duo(
  ...
  ".inverse .remark-slide-number" = list("display" = "none;"),
    ...
    ".code_text_100" = list("font-weight" = "bold", "font-size"= "100%"),
    ".code_text_090" = list("font-weight" = "bold", "font-size"= "90%"),
    ".code_text_080" = list("font-weight" = "bold", "font-size"= "80%"),
    ".code_text_070" = list("font-weight" = "bold", "font-size"= "70%"),
    ".code_text_060" = list("font-weight" = "bold", "font-size"= "60%"),
    ".code_text_050" = list("font-weight" = "bold", "font-size"= "50%")
    ,
    ".large_text" = list(
      "font-family" = "Lato", 
      "font-size"= "150%"
...
# preview slides
# xaringan::inf_mr('03_dia_01_sesion_02a_descriptivos.rmd')
...
knitr::include_graphics('./files/mlm_paraguay.png')
```
